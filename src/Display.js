...
class Display extends Component {
    ...
    selectView = () => {
            ...
            return (
                ...
                <div>
                    <div  >
                        ...
                        <div >
                            <h1 class="questionText">{QuestionsArray[this.state.currentQuestionIndex]}</h1>
                    ...
                    <div>
                        {/* wrong Button */}
                        <button className="border-0" style={{ backgroundColor: "transparent" }} onClick={() => this.setScore(false)}>
                            <img src={wrong2} alt="wrong icon" height="120px" />

                        </button>

                        {/* correct Button */}
                        <button className="border-0" style={{ backgroundColor: "transparent" }} onClick={() => this.setScore(true)} >
        ...
        // reached the end of questions view
    ...
    setScore = (UserChoice) => {
        ...
        if (currentQuestionIndex !== (Questions.length) && currentLives > 0) {
            ...
            console.log('this.state.choice is %s', UserChoice)
            ...
            // if (this.state.choice !== Questions[currentQuestionIndex].result)
                ...
                console.log("wrong currenewScorentScore")
    ...
    render() {
        ...
        const balloons = Array.from({ length: this.state.currentLives }, (_, i) => <img className="animated infinite heartBeat " key={i} src={live} height="65px" role="presentational" />)
                ...
                <>
                    ...
                    <Navbar bg="dark" >
                        <div className="mx-auto">
                            ...
                            <Navbar.Brand className="text-white myNavText ">Score: {this.state.score} </Navbar.Brand>


                            <Navbar.Brand className="text-white"><img src={gameIcon} alt="evil clown" height="80px" /></Navbar.Brand>

                            <Navbar.Brand className="text-white myNavText">Lives: {balloons} </Navbar.Brand>
                        </div>
